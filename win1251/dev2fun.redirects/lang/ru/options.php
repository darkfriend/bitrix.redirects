<?php
$MESS["D2F_REDIRECTS_DONATE_MESSAGES"] = "Вы используете бесплатный модуль. Ваши донаты стимулируют скорость выпуска новых обновлений, а также новых бесплатных модулей. <a href='#LINK#' target='_blank'>Поддержать разработчиков</a>";

$MESS["LABEL_ADD"] = "Добавить";

$MESS["D2F_REDIRECTS_LABEL_ENABLE"] = "Активность";
$MESS["D2F_REDIRECTS_LABEL_REDIRECTS"] = "Настройка редиректов";
$MESS["D2F_REDIRECTS_REDIRECTS_NOTE"] = "В данной версии вы можете настроить редиректы напрямую в <a href='/bitrix/admin/highloadblock_rows_list.php?ENTITY_ID=#ID#' target='_blank'>highloadblock bitrix</a>";
